...
io.sockets.on('connection', function (socket) {
    ...
    socket.on('clientName', function(name){
        console.log("nom client recu")
        console.log(name);
        socket.on('clientFirstname', function(firstname){
            console.log("prénom client recu");
            console.log(firstname);
            socket.on('clientNumber', function(number){
                console.log("numéro client recu");
                console.log(number);
                socket.on('clientAdress', function(adress){
                    console.log("adresse client recu");
                    console.log(adress);
                    socket.on('clientCity', function(city){
                        console.log("ville client recu");
                        console.log(city);
                        socket.on('clientMail', function(mail){
                            console.log("mail client recu");
                            console.log(mail);
                                ...
                                /*var newClient = { Clientname: name, clientFirstname: firstname, clientNumber: number, clientAdress: adress, clientCity: city, clientMail: mail, clientPrecRot : precRot, clientNextRot : nextRot, clientFumureName : fumureName, clientRdt : rdt, clientAvis : avis, clientFertFarmStarName : fertFarmStarName, clientAnaSolName : anaSolName, clientBilanNames : bilanNames, clientCartoRdtName : cartoRdtName, clientDaterecolte : daterecolte, clientSemoirs : semoirs, clientModeDestruction : modeDestruction, clientRemParcelle : remParcelle, clientCompactions : compactions, clientAdventices : adventices, clientMaladies : maladies, clientRavageurs : ravageurs};*/
                                    
                                var newClient = { Clientname: name, clientFirstname: firstname, clientNumber: number, clientAdress: adress, clientCity: city, clientMail: mail};
                                    
                                                                  
                                db.collection("clients").insert(newClient, null, function (error, results) {
